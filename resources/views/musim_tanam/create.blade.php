@extends('layouts.app')
@section('title', 'Tambah Musim Tanam — Smart Irrigation')
@section('page-title', 'Tambah Musim Tanam')
...
<div style="max-width:640px;margin:0 auto;">
    ...
    <div class="form-card">
        <div style="margin-bottom:1.75rem;">
            ...
            <h2 style="font-family:'Fraunces',serif;font-size:1.5rem;font-weight:700;color:var(--soil);letter-spacing:-.02em;">Tambah Musim Tanam</h2>
        </div>

        <div class="info-box">
            ℹ️ Jika status diset <strong>Berjalan</strong>, musim tanam lain yang sedang berjalan akan otomatis diubah ke <strong>Selesai</strong>.
        </div>
        ...
        <form method="POST" action="{{ route('musim-tanam.store') }}">
            @csrf
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <div style="display:grid;grid-template-columns:2fr 1fr;gap:1rem;">
                    <div>
                        ...
                        <input type="text" name="nama_mt" value="{{ old('nama_mt') }}"
                    ...
                    <div>
                        ...
                        <select name="jenis_mt" required class="form-input">
                            @foreach(['MT1','MT2','MT3','MK'] as $jenis)
                                <option value="{{ $jenis }}" {{ old('jenis_mt') == $jenis ? 'selected' : '' }}>
                                    {{ $jenis }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div style="margin-bottom:1.5rem;">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                    <div>
                        ...
                        <input type="number" name="target_luas_tanam" value="{{ old('target_luas_tanam') }}"
                            step="0.01" min="0" required placeholder="cth: 150.00" class="form-input">
                    </div>
                    <div>
                        <label class="form-label">Jenis Tanaman <span>*</span></label>
                        <input type="text" name="jenis_tanaman" value="{{ old('jenis_tanaman', 'Padi') }}"
            ...
            <div style="display:flex;gap:.75rem;">
                <button type="submit" class="btn-primary">Simpan Musim Tanam</button>
